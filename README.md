...
<body class="font-body bg-corporate text-slate-100 antialiased selection:bg-yellow-600 selection:text-white pb-10">
    ...
    <section id="resolusi" class="py-20 bg-[#000000]/40 border-t border-white/5 scroll-mt-20">
    ...
    <footer class="bg-black py-8 border-t border-white/10 text-center">
        <p class="text-slate-500 text-xs tracking-widest uppercase">hak cipta terpelihara @S3MOHERO 2025/2026</p>
    </footer>
